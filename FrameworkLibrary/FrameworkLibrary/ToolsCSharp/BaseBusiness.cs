...
namespace ToolsCSharp
{
    ...
    public abstract class BaseBusiness
    {
        ...
        public BaseBusiness()
        {
            SetUp();//obj instantiation
            SetRequiredRules();//set rules and prop
        ...
        {
            if (mIsDeleted && !mIsNew)//if its being deleted and not new obj call delete metho
            {
